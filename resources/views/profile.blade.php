           ...
           <div class="col-md-3">
               <div class="card">
                   <div class="card-body">
                       <div class="text-center">
                           <img src="{{ $user->image ? $user->image: 'http://picsum.photos/50/50' }}" width="85" class="rounded-circle">
            ...
            @if(!empty($posts))
                @foreach($posts as $post)
                    <!-- $posts คือ ตัวที่มีค่ามากกว่า 1 ค่าหรือเก็บค่ามากกว่า 1 ค่า
                       เช่น arry หรื่อตัวแปลชนิดอื่นๆที่มีการเก็บค่าหลายๆค่าไว้
                        $post เฉยๆไม่มี s คือตัวแปลที่ทำหน้าที่วิ่งส่ง วิ่งใช้ทีละ 1 ค้่าจาก $posts
                        วนไปเรื่อยๆตามจำนวนที่มีอยู่ใน $posts ดังนั้นถ้าไม่มี s คือตัวแปรที่ใช้วิ่งวน คล้ายกับ
                        ตัวแปล i ใน for ของภาษาซี เช่น for(i=0;i++;i<$posts){cout << i;}
                        7 ต้องการให้เหลือ 6-1
                        8 ต้องการให้เหลือ 7-1
                        9 ต้องการให้เหลือ 8-1
                        n ต้องการให้เหลือ n-1
                        dynamic programing คือ มีการเคลื่อนไหว เปลี่ยนแปลงตามเงื่อนไขต่างๆ
